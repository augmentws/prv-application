...
export function StatusBadge({ status, className }: { status: string; className?: string }) {
  ...
  const pending = new Set(["QUEUED", "SNAPSHOTTING", "PLANNING", "RUNNING", "DELETING", "DELETING_DATABASE_ROWS", "DELETING_BLOBS", "VALIDATING", "WAITING_APPROVAL", "AWAITING_REVIEW", "APPROVED"]);
